...
recv_ip = "0.0.0.0"                                                         #IP of this Machine
CCRSessionid = None
CCRDest_host = None
CCRDest_realm = None
CCRueIp = None
...
diameter_host ="hss01.epc.mnc001.mcc001.3gppnetwork.org"                                                        #Diameter Host of this Machine
realm ="epc.mnc001.mcc001.3gppnetwork.org"                                         #Diameter Realm of this machine
DestinationHost = "smf.epc.mnc001.mcc001.3gppnetwork.org"                                             #Diameter Host of Destination
DestinationRealm = "epc.mnc001.mcc001.3gppnetwork.org"                                                #Diameter Realm of Destination
hostname = "10.0.3.6"                                                         #IP of Remote Diameter Host
